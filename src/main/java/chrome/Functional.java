...
public class Functional {
	...
	public static void pageSignUpValidation(String url) {
		...
		System.out.println("11. UI element [Gender text Female]: " + (isPresent(item_11) ? "Exists" : "Not exist")); // signup
																														...
																														// confirmation
		System.out
				.println("12. UI element [Sign Up &confirmation]: " + (isPresent(item_12) ? "Exists" : "Not exist")); // signup
																														// &
																														// confirmation
	...
	public static void pageConfirmationValidation(String url) {
		...
		System.out.println("11. UI element [Gender text Female]: " + (isPresent(item_01) ? "Exists" : "Not exist")); // signup
																														// &
																														// confirmation
		System.out
				.println("12. UI element [Sign Up &confirmation]: " + (isPresent(item_12) ? "Exists" : "Not exist")); // signup
