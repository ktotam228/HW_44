...
public class Linear {
	...
	public static void main(String[] args) {
		...
		System.out.println("14. Element [Genre (label)]: " + 		(isPresent(el_14) ? "Exists" : "Not exist"));		// signup & confirmation
		...
		System.out.println("42. Element [Genrge (field)): " + 	(isPresent(el_42) ? "Exists" : " Not exist"));		// confirmation
